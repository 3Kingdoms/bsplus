...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsInstructionsText':('Pokud chcete propojit účty, na jednom z nich generujte kód\n'
                                        ...
                                        '\n'
                                        'Ale opatrně; Tuto akci nelze vrátit zpět!'),
    ...
    'helpWindow':{
        ...
        'jumpInfoText':('- Skok -\n'
                        ...
                        'jen tak z radosti.'),
        'orPunchingSomethingText':'Nebo praštění něčeho, vyhození toho z útesu, a nebo odstřelení toho s lepivou bombou, směrem dolů',
    ...
    'store':{
        ...
        'bombSquadProNewDescriptionText':('• Odstraňují ve hře reklamy\n'
                                          '• A k tomu:'),
        'buyText':'Koupit',
    ...
    'tutorial':{
        ...
        'phrase13Text':'Uuups; za to promiň ${NAME}.',
        'phrase14Text':'Některé věci můžete chytit a hodit. Třeba vlajky.. nebo ${NAME}ho.',
        'phrase15Text':'A hlavně, jsou tu bomby.',
        'phrase16Text':'Naučit se házet bomby zabere čas.',
        'phrase17Text':'Au! To nebyl moc dobrý hod.',
        ...
        'phrase24Text':'Hurá! Parádně načasováno.',
        'phrase25Text':'No, to bude vše.',
        'phrase26Text':'Teď běž, tygře!!!',
        'phrase27Text':'Zapamatuj si tréning, a určitě se vrátíš živý!',
        'phrase28Text':'...teda, možná...',
        'phrase29Text':'Hodně štěstí!',
        'randomName1Text':'Lukáš',
        'randomName2Text':'Marek',
        'randomName3Text':'Loki',
        'randomName4Text':'Dante',
        'randomName5Text':'Slendy',
