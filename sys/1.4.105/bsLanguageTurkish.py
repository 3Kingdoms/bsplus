...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsInstructionsText':('İki hesabı bağlamak için, birinde bir kod oluşturun \n'
                                        've o kodu diğerine girin.\n'
                                        'İlerlemeler ve envanter birleşecektir.\n'
    ...
    'disableXInputDescriptionText':'4 kontrolcüden fazla kullanılabilir fakat iyi calısmayabilir.',
    ...
    'store':{
        ...
        'bombSquadProNewDescriptionText':('• Oyun-içi reklam kalkar\n'
                                          '• Ayrıca şunları icerir:'),
        'buyText':'Satın Al',
