...
values = {
    'accountSettingsWindow':{
        ...
        'signInInfoText':('Entre para ganhar cupons, jogar online e compartilhar\n'
    ...
    'achievements':{
        ...
        'Stayin\' Alive':{
            ...
            'name':'Tá Tranquilo, Tá Favorável'
        },
        'Super Mega Punch':{
    ...
    'audioSettingsWindow':{
        ...
        'headRelativeVRAudioText':'Áudio para Fones VR',
    ...
    'challengeEndedText':'Esse desafio acabou.',
    'choosingPlayerText':'<escolhendo jogador>',
    'completeThisLevelToProceedText':('Complete esse nível\n'
                                      'para continuar!'),
    ...
    'configGamepadWindow':{
        ...
        'appliesToAllText':'(serve para todos os controles desse tipo)',
        ...
        'ignoreCompletelyDescriptionText':'(impedir esse controle de afetar tanto o jogo quanto o menu)',
    ...
    'coopSelectWindow':{
        ...
        'challengesInfoText':('Ganhe prêmios por completar minigames.\n'
                              '\n'
        ...
        'forfeitConfirmText':'Abandonar esse desafio?',
        'forfeitNotAllowedYetText':'Esse desafio ainda não pode ser abandonado.',
    ...
    'debugText':'depurar',
    'debugWindow':{
        'reloadBenchmarkBestResultsText':'Nota: Recomenda-se que ajuste Configurações > Gráficos > Texturas para "Alto" ao testar.',
        ...
        'titleText':'Testes de Performance & Estabilidade',
    ...
    'gatherWindow':{
        ...
        'aboutDescriptionText':('Use essas guias para montar uma sala.\n'
                                '\n'
                                'Salas o permitem jogar com seus amigos\n'
        ...
        'earnTicketsForRecommendingAmountText':('Amigos ganharão ${COUNT} cupons ao experimentar o jogo\n'
                                                '(e você ganhará ${YOU_COUNT} por cada um que o fizer)'),
        'earnTicketsForRecommendingText':('Compartilhe o jogo\n'
                                          'para cupons grátis...'),
        'emailItText':'Enviar Email',
        ...
        'wifiDirectDescriptionBottomText':('Se todos os dispositivos tiverem \'Wi-Fi Direct\', poderão usar para encontrar\n'
                                           ...
                                           '\n'
                                           'Para melhores resultados, o host do Wi-Fi Direct deverá ser também o host do grupo do ${APP_NAME}.'),
    ...
    'getTicketsWindow':{
        ...
        'unavailableLinkAccountText':('Desculpe, as compras não estão disponíveis nesta plataforma.\n'
                                      'Como solução alternativa, você pode vincular essa conta para\n'
        ...
        'versionTooOldText':'Desculpe, a versão do jogo é muito antiga; por favor atualize.',
    ...
    'helpWindow':{
        ...
        'controllersInfoText':('Dá para jogar ${APP_NAME} com amigos em rede, ou podem\n'
                               'todos jogarem no mesmo dispositivo se tiverem controles.\n'
                               '${APP_NAME} suporta muitos deles; pode até mesmo usar\n'
                               'smartphones como controle com o aplicativo \'${REMOTE_APP_NAME}\'.\n'
        ...
        'powerupLandMinesDescriptionText':('Esses vêm em pacotes com 3;\n'
        ...
        'toGetTheMostText':'Para aproveitar ao máximo esse jogo, você vai precisar de:',
    ...
    'internal':{
        ...
        'controllerForMenusOnlyText':'Esse controle não pode ser usado para jogar; apenas para navegar pelo menu.',
        ...
        'corruptFileText':'Arquivos corrompidos detectados. Tente reinstalar o jogo ou mande um email para ${EMAIL}',
        ...
        'incompatibleNewerVersionHostText':('O dono da sala usa uma versão diferente da sua.\n'
        ...
        'joinedPartyInstructionsText':('Um jogador entrou na sua sala.\n'
        ...
        'telnetAccessDeniedText':'ERRO: usuário não liberou acesso telnet.',
    ...
    'kickVoteFailedText':'Votação para expulsão falhou.',
    ...
    'league':{
        ...
        'tournamentLeagueText':'Deve alcançar a liga ${NAME} para ter acesso a esse torneio.',
    ...
    'loadingTryAgainText':'Carregando; tente novamente em um momento...',
    'mainMenu':{
    ...
    'noValidMapsErrorText':'Nenhum mapa válido encontrado para esse tipo de jogo.',
    ...
    'playerText':'Jogador',
    'playlistNoValidGamesErrorText':'Essa playlist não contém nenhum jogo desbloqueado válido.',
    ...
    'pleaseRateText':('Se você está curtindo ${APP_NAME}, por favor dê um tempinho\n'
                      'para avaliar e comentar.  Isso nos dá feedbacks úteis\n'
    ...
    'pressJumpToFlyText':'** Aperte pular repetidamente para voar **',
    ...
    'pressToSelectTeamText':'aperte ${BUTTONS} para selecionar uma equipa',
    ...
    'remote_app':{
        ...
        'cant_resolve_host':'Impossível localizar host.',
        'capturing':'Aguardando...',
        'connected':'Conectado.',
        'description':('Use seu telefone ou tablet como controle com BombSquad.\n'
                       'Até 8 dispositivos podem conectar de uma vez para uma loucura épica local multijogador numa TV ou tablet.'),
    ...
    'replaysText':'Replays',
    'reportPlayerExplanationText':('Use este email para denunciar trapaças, linguagem inapropriada, ou outro comportamento ruim.\n'
    ...
    'settingsWindow':{
        ...
        'playerProfilesMovedText':'Nota: Perfis de Jogador foram movidos à janela de Conta no menu principal.',
    ...
    'settingsWindowAdvanced':{
        ...
        'translationFetchingStatusText':'checando status da tradução...',
        'translationNoUpdateNeededText':'a linguagem atual está atualizada; woohoo!',
        'translationUpdateNeededText':'** o idioma atual precisa de atualizações!! **',
        'vrTestingText':'Teste de VR'
    },
    'shareText':'Compartilhar',
    'sharingText':'Compartilhando...',
    'showText':'Mostrar',
    'signInForPromoCodeText':'Você deve logar a uma conta para que códigos promocionais se efetuem.',
    'signInWithGameCenterText':('Para usar uma conta Game Center,\n'
                                'logue com o app Game Center.'),
    ...
    'store':{
        ...
        'freeBombSquadProText':('BombSquad agora é gratuito, mas já que você já tinha comprado ele\n'
                                'você esta recebendo o upgrade BombSquad pro e ${COUNT} tickets\n'
                                'como um obrigado.\n'
        ...
        'howToUseMapsText':'(use estes mapas em suas próprias playlist de times/Livre)',
        'iconsText':'Ícones',
        'loadErrorText':('Incapaz de carregar a página.\n'
                         'Verifique a sua conexão de internet.'),
        'loadingText':'carregando',
        'mapsText':'Mapas',
        'miniGamesText':'Mini-Jogos',
        ...
        'saleText':'PROMOÇÃO',
        'searchText':'Buscar',
        'teamsFreeForAllGamesText':'Times / Jogos Cada-um-por-si',
        'winterSpecialText':'Especial de Inverno',
        'youOwnThisText':'- você tem isso -'
    },
    'storeDescriptionText':('Loucura total com até 8 jogadores!\n'
                            '\n'
                            'Exploda seus amigos (ou o CPU) num torneio de mini-jogos desafiadores como Capture a Bandeira, Hockey Bombástico, e Mata-Mata em câmera lenta épica\n'
                            '\n'
                            'Controles normais e controles externos possibilitam jogar com até 8 pessoas no mesmo aparelho; você também pode usar outros aparelhos como controles externos usando o app grátis ‘BombSquad Remote’!\n'
                            '\n'
    ...
    'storeDescriptions':{
        ...
        'competeInMiniGamesText':'Compita em mini games que vão de corridas a vôos.',
        'customize2Text':'Customize personagens, mini-games e até mesmo a trilha sonora.',
        'customizeText':'Customize personagens e crie sua própria lista de mini-games.',
    ...
    'testBuildErrorText':'Essa versão de testa não é mais suportada; por favor baixe a nova versão.',
    ...
    'tournamentCheckingStateText':'Checando o estado do torneio; espere um momento...',
    'tournamentEndedText':'Esse torneio foi finalizado. Um novo começará em breve.',
    ...
    'translations':{
        ...
        'serverResponses':{
            ...
            'Account linking successful!':'Link de conta sucedido!',
            'Accounts are already linked.':'Contas já estão linkadas.',
            'An error has occurred; please contact support@froemling.net.':'Um erro ocorreu; por favor contate support@froemling.net',
            ...
            ('Are you sure you want to link these accounts?\n'
             ...
             '${ACCOUNT2}\n'
             '\n'
             'This cannot be undone!'):('Quer mesmo linkar estas contas?\n'
                                        '\n'
                                        '${ACCOUNT1}\n'
                                        '${ACCOUNT2}\n'
                                        '\n'
            ...
            'Can\'t link 2 accounts of this type.':'Não se pode linkar contas desse tipo.',
            'Can\'t link 2 diamond league accounts.':'Não se pode linkar duas contas liga diamante.',
            'Can\'t link; would surpass maximum of ${COUNT} linked accounts.':'Impossível linkar; ultrapassaria o máximo de ${COUNT} contas linkadas.',
            ...
            'Purchase successful!':'Compra feita com sucesso!',
            ...
            ('Would you like to link your device account to this one?\n'
             ...
             'Warning: this cannot be undone!\n'):('Gostaria de linkar sua conta de dispositivo com esta?\n'
                                                   '\n'
            ...
            'You got ${COUNT} tickets!':'Você tem ${COUNT} tickets!',
            ...
            'You must update to a newer version of the app to do this.':'Você deve atualizar para uma nova versão do app para isso.',
            'You must wait a few seconds before entering a new code.':'Você deve esperar alguns segundos antes de digitar um novo código.',
            'You ranked #${RANK} in the last tournament. Thanks for playing!':'Você teve a classificação #${RANK} no ultimo torneio. Obrigado por jogar!',
        ...
        'settingNames':{
            ...
            'Normal':'Normal',
            'Pro Mode':'Modo Pro',
            'Respawn Times':'Número de Respawns',
        ...
        'tips':{
            ('A perfectly timed running-jumping-spin-punch can kill in a single hit\n'
             'and earn you lifelong respect from your friends.'):('Um soco-correndo-pulando-girando perfeitamente sincronizado pode\n'
                                                                  'matar em um único golpe e garantir o respeito eterno de seus amigos.'),
            ...
            'Jump just as you\'re throwing to get bombs up to the highest levels.':'Apenas pule enquanto você está arremessando para conseguir bombas até os níveis mais altos.',
            ...
            ('The head is the most vulnerable area, so a sticky-bomb\n'
             'to the noggin usually means game-over.'):('A cabeça é a área mais vulnerável, portanto uma bomba grudenta\n'
                                                        'na cuca geralmente significa game-over.'),
    ...
    'trophiesThisSeasonText':'Toféis nessa temporada',
    'tutorial':{
        ...
        'phrase19Text':'Pular te ajuda a arremessar mais alto.',
    ...
    'usesExternalControllerText':'Este jogo usa um comando externo.',
    ...
    'watchWindow':{
        'deleteConfirmText':'Deletar "${REPLAY}"?',
        'deleteReplayButtonText':('Deletar\n'
                                  'Replay'),
        ...
        'renameText':'Renomear',
        'replayDeleteErrorText':'Erro ao deletar replay.',
        'replayNameText':'Nome do Replay',
        'replayRenameErrorAlreadyExistsText':'Um replay com esse nome já existe.',
