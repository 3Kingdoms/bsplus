...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsInstructionsText':('Pour lier deux comptes, générez un code sur l\'un\n'
                                        'd\'entre eux puis entrez ce code sur l\'autre.\n'
                                        'La progression et l\'inventaire seront combinés.\n'
                                        'Vous pouvez joindre jusqu\'à ${COUNT} comptes.\n'
                                        '\n'
    ...
    'settingsWindowAdvanced':{
        ...
        'kidFriendlyModeText':'Mode Enfant-Gentil (moins de la violence, etc)',
    ...
    'store':{
        ...
        'bombSquadProNewDescriptionText':('• Supprime les annonces dans le jeu\n'
                                          '• Comprend également:'),
        'buyText':'Acheter',
